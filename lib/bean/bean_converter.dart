...
import 'package:mx_env/bean/web_version/web_version.dart';
import 'package:mx_env/bean/product/product.dart';

export 'package:mx_env/bean/web_version/web_version.dart';
export 'package:mx_env/bean/product/product.dart';
/// 使用腳本自動產生轉換Bean
class BeanConverter {
...
final _factories = <Type, Function>{
    ProductBean: (jsonData) => ProductBean.fromJson(jsonData),
    WebVersionBean: (jsonData) => WebVersionBean.fromJson(jsonData),
};
